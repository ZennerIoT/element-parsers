...
* 2026-05-06: Allow multiple different forwards within one packet (long header only)
* 2026-02-09: Handle other filter on bridge than 0x00. Not used for parsing
...
* 2026-05-08: Added handling of device information payload (0x6A)
...
* 2025-11-05: Added possibility to add gateway connection stats to reading
...
* 2025-11-19: Added calculation for remaining fill level
...
* 2026-06-24: Added minimal Payload length to catch undefined short payloads
...
* 2025-10-01: Added Port 3 and 4 according to HVSSR110_Decoder_Format.pdf
...
* 2025-12-03: Fixed counter failure due to port 2 packet
...
* 2025-10-23: Fixed handling payload with unknown tank.
