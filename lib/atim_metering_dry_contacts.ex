defmodule Parser do
  ...
  def parse(
        <<0x07, 0x02, device_type, acw_version::little-16, radio_type, radio_version::little-16,
  ...
  def tests() do
    [
      ...
      # keep alive
      {:parse_hex, "015F845F8464", %{meta: %{frame_port: 1}},
       %{power_supply1: 24452, power_supply2: 24452, type: :keep_alive}},
