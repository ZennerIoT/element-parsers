defmodule Parser do
  ...
  def tests() do
    [
      # Readings
      {:parse_hex, "43303A31383237", %{meta: %{frame_port: 3}},
       %{distance: 1827, type: :reading}},
      {:parse_hex, "43303A30333030", %{meta: %{frame_port: 3}}, %{distance: 300, type: :reading}},
      {:parse_hex, "43303A31383439", %{meta: %{frame_port: 3}},
       %{distance: 1849, type: :reading}},

      # Inquiries
      {:parse_hex, "3F423A33363430", %{meta: %{frame_port: 3}},
       %{battery_voltage: 3.64, type: :inquiry}},
      {:parse_hex, "3F443A3030303233", %{meta: %{frame_port: 3}},
       %{device_type: "00023", type: :inquiry}},
      # TODO: Get real interval inquiry (3F49...)
      {:parse_hex, Base.encode16("?I:0030"), %{meta: %{frame_port: 3}},
       %{interval_minutes: 30, type: :inquiry}},
      {:parse_hex, "3F533A3030313037303834", %{meta: %{frame_port: 3}},
       %{serial_number: "00107084", type: :inquiry}},
      {:parse_hex, "3F543A4657522D313031302D3035", %{meta: %{frame_port: 3}},
       %{firmware_type: "FWR-1010-05", type: :inquiry}},
      {:parse_hex, "3F563A5630312E30312E3030", %{meta: %{frame_port: 3}},
       %{firmware_version: "V01.01.00", type: :inquiry}},
