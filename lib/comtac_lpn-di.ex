defmodule Parser do
  ...
  def parse(
        <<
          ...
          snr_value::signed,
          di_state::binary-1,
          di1_counter::32-little,
          di2_counter::32-little,
          di1_secs_change::24-little,
          di2_secs_change::24-little
        >>,
        %{meta: %{frame_port: 3}}
      ) do
    <<
  ...
  def tests() do
    [
      {
        :parse_hex,
        "15000266FF100000000000000000FFFFFFFFFFFF",
        %{meta: %{frame_port: 3}},
        %{
          software: "v0.2",
          di1_changed: 0,
      ...
      {
        :parse_hex,
        "1500026704100000000000000000FFFFFFFFFFFF",
        %{meta: %{frame_port: 3}},
        %{
          software: "v0.2",
          di1_changed: 0,
