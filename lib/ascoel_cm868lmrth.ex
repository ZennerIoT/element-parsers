defmodule Parser do
  ...
  def parse(<<evt::8, count::16, temp::float-little-32, hum::float-little-32>>, %{
        meta: %{frame_port: 30}
      }) do
  ...
  def parse(<<_bat_t::1, bat_p::7, evt::8, temp::float-little-32, hum::float-little-32>>, %{
        meta: %{frame_port: 9}
      }) do
    <<_res::3, _ins::2, blow::1, tamper::1, intr::1>> = <<evt::8>>
