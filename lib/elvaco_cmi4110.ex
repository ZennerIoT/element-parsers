defmodule Parser do
  ...
  defp extend_reading(readings) when is_list(readings),
    do: Enum.map(readings, &extend_reading(&1))
  ...
  defp build_error_string(
         <<bit15::1, bit14::1, bit13::1, bit12::1, eeprom_heads_up::1, dirt_heads_up::1,
           electronic_error::1, eight_hours_exceeded::1, internal_memory_disturbance::1,
           short_circuit_temperature_sensor_cold_side::1,
           short_circuit_temperature_sensor_warm_side::1, supply_voltage_low::1,
           electronic_malfunction::1, disruption_temperature_sensor_cold_side::1,
           disruption_temperature_sensor_warm_side::1, error_flow_measurement::1>>
       ) do
    []
    ...
    |> concat_if(
      eight_hours_exceeded,
      "F8 - F1, F2, F3, F5 oder F6 stehen länger als 8 Stunden an"
    )
    |> concat_if(
      internal_memory_disturbance,
      "F7 - Störung im internen Speicher (ROM oder EEPROM)"
    )
    |> concat_if(
      short_circuit_temperature_sensor_cold_side,
      "F6 - Kurzschluss Termperaturfühler kalte Seite"
    )
    |> concat_if(
      short_circuit_temperature_sensor_warm_side,
      "F5 - Kurzschluss Termperaturfühler warme Seite"
    )
    ...
    |> concat_if(
      disruption_temperature_sensor_cold_side,
      "F2 - Unterbrechung Temperaturfühler kalte Seite"
    )
    |> concat_if(
      disruption_temperature_sensor_warm_side,
      "F1 - Unterbrechung Temperaturfühler warme Seite"
    )
    |> concat_if(
      error_flow_measurement,
      "F0 - Fehler bei Durchflussmessung (z.B. Luft im Messrohr)"
    )
  ...
  def tests() do
    [
      ...
      {
        :parse_hex,
        "000C06150110000C782791206802FD170600",
        %{},
        %{
          "6-0:1.0.0": 100_115.0,
          energy: 100_115.0,
          ...
          error_codes: 1,
          error:
            "F2 - Unterbrechung Temperaturfühler kalte Seite;F1 - Unterbrechung Temperaturfühler warme Seite",
          fabrication_block: 68_209_127,
          fabrication_block_unit: "MeterID",
          function_field: :current_value,
          payload_style: 0
        }
      ...
      {
        :parse_hex,
        "000C06748823000C14099850000B2D0801000B3B6201000A5A54090A5E79030C788851276702FD170000",
        %{},
        %{
          "flow_unit" => "m³/h",
          "power_unit" => "W",
      ...
      {
        :parse_hex,
        "000C06365518000C14136528003B2E0000003B3E0000003A5B00003A5F00000C788414916502FD170304",
        %{},
        %{
          "flow_unit" => "m³/h",
          "power_unit" => "W",
          ...
          :energy_unit => "kWh",
          :error =>
            "Verschmutzungs-Vorwarnung der Messstrecke;F1 - Unterbrechung Temperaturfühler warme Seite;F0 - Fehler bei Durchflussmessung (z.B. Luft im Messrohr)",
          :error_codes => 1,
          :fabrication_block => 65_911_484,
          :fabrication_block_unit => "MeterID",
          :flow => 0,
          :function_field => :current_value,
          :payload_style => 0,
      ...
      {
        :parse_hex,
        "010C07905510000C786734966902FD170040",
        %{},
        %{
          energy: 1.0559e6,
          "6-0:1.0.0": 1.0559e6,
      ...
      {
        :parse_hex,
        "1E04068E6002000413D6082200022B0000023B0000025A4300025E3B00077961576851A511400401FD1784",
        %{},
        %{
          :"6-0:1.0.0" => 155_790.0,
          :energy => 155_790.0,
