defmodule Parser do
    ...
    {row, _rest} =
      case behaviour do
        1 ->
          ...
          row =
            Map.merge(row, %{send_usage: %{0 => :only_when_new_data, 1 => :always}[send_usage]})
  ...
  def parse(<<0x05, configured_params::binary-1, rest::binary>>, %{meta: %{frame_port: 50}}) do
    <<_::3, meter_serial::1, _::1, reading_offset::1, reading_absolute::1, general_config::1>> =
      configured_params
  ...
  # Boot Message
  def parse(
        <<0x00, serial::4-binary, firmware::3-binary, reset_reason, general_info::binary-1,
          _hardware_config, sensor_fw_version::16-little, device_uptime::24>>,
        %{meta: %{frame_port: 99}}
      ) do
    ...
    [
      {
        # Status message
        :parse_hex,
        # 010000FF110E0082F606447400
        "018008FF9212005207A0000000",
        %{meta: %{frame_port: 24}},
        %{
          battery_offset: 146,
          counter: 160,
