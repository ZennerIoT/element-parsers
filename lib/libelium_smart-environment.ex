defmodule Parser do
  ...
  def parse(
        <<so2::big-16, o3::big-16, co::big-16, no2::big-16, temp::big-16-signed, hum::big-16,
          pres::big-16, pm1::big-16, pm25::big-16, pm10::big-16, power::big-16>>,
        _meta
      ) do
    # return value map
    %{
      ...
      # Pressure in hPa
      pres: pres / 10,
      # Particle Matter PM1 in µg/m³
      pm1: pm1 / 100,
      # Particle Matter PM2,5 in µg/m³
      pm25: pm25 / 100,
      # Particle Matter PM10 in µg/m³
      pm10: pm10 / 100,
      # Battery level in %
      power: power
    }
