defmodule Parser do
  ...
  # Status Message
  def parse(
        <<usage::little-32, _battery::signed-8, temperature::signed-8, _rssi::binary-1,
          _rest::binary>>,
        %{meta: %{frame_port: 24}}
      ) do
    %{
  ...
  # Boot/Debug Message
  def parse(<<0x00, serial::binary-4, firmware::24, meter_id::little-32, _rest::binary>>, %{
        meta: %{frame_port: 99}
      }) do
    <<a, b, c, d>> = serial
  ...
  def tests() do
    [
      ...
      {
        :parse_hex,
        "003A00024B00029897C8BF01",
        %{meta: %{frame_port: 99}},
        %{
          message_type: "boot",
          serial_nr: "4B02003A",
          firmware: "0.2.152",
          elster_id: 29_345_943
        }
      },
      {
        :parse_hex,
        "007E00124B00041310734856398200000002",
        %{meta: %{frame_port: 99}},
        %{
          elster_id: 1_447_588_624,
          firmware: "0.4.19",
          message_type: "boot",
          serial_nr: "4B12007E"
        }
