defmodule Parser do
  ...
  def parse(
        <<latitude::signed-little-32, longitude::signed-little-32, _rfu::5, down::1, failed::1,
          in_trip::1, speed::little-5, heading::little-3, battery::little-8>>,
        %{meta: %{frame_port: 1}}
      ) do
    gpslatitude = latitude / 10_000_000
    gpslongitude = longitude / 10_000_000
    ...
    {%{
     ...
     [
       # GPS coordinates as GEO Point for showing in map
  ...
  def parse(<<msg::88>>, %{meta: %{frame_port: 3}}) do
    <<uptime::9, wakeups::7, avg_gps_fresh::8, avg_gps_fail::9, avg_gps_fix::9, gps_fails::8,
      gps_success::10, trip_count::13, tx_count::11, initial_bat::4>> = <<msg::little-88>>
  ...
  def tests() do
    [
      ...
      {:parse_hex, "53AB783C0421F98E04CAB3", %{meta: %{frame_port: 1}},
       {%{
          type: :record,
          man_down: "true",
          last_fix: "did not fail",
          trip: "Out of trip",
          heading: 90,
          speed: 125,
          battery: 4475
        }, [location: {-189.6275708, 101.4541139}]}},
      {:parse_hex, "D30102", %{meta: %{frame_port: 2}},
       %{type: :ack, downlink: "accepted", seq_no: 83, version: "1.2"}},
      {:parse_hex, "8BF3DC7B9438984278B85E", %{meta: %{frame_port: 3}},
       %{
         type: :statistics,
         initial_bat: 5.1,
         tx_count: 59136,
