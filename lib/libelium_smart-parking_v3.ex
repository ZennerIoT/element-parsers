defmodule Parser do
  ...
  def parse(
        <<parking_slot_status::1, battery_state::1, config_up_ack::1, sensor_recalibration::1,
          frame_type::4, frame_counter::8, rest::binary>> = payload,
        _meta
      )
      when byte_size(payload) == 11 do
    data = %{
      ...
      # Will be set by parse_frame_rest()
      frame_type_name: "unknown",
      # This byte can be used to detect lost frames (sent by the node but not received).
